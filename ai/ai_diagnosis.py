...
path = 'D:\\sem5\\frontend\\temp\\Neurora-Backend\\ai\Models\\'
...
model34 = pickle.load(open(path + "KNN_task.sav", "rb"))
model35 = pickle.load(open(path + "KNN_EC.sav", "rb"))
model36 = pickle.load(open(path + "KNN_EO.sav", "rb"))
